        ...
        <fieldset style="width: 420px; height: 120px;">
            ...
            <label>
                <input type="checkbox" name="checkDrinks[]" value="Coke" 
                    <?php if (isset($_POST['checkDrinks']) && in_array('Coke', $_POST['checkDrinks'])) echo 'checked'; ?>> Coke - ₱15<br>
                <input type="checkbox" name="checkDrinks[]" value="Sprite" 
                    <?php if (isset($_POST['checkDrinks']) && in_array('Sprite', $_POST['checkDrinks'])) echo 'checked'; ?>> Sprite - ₱20<br>
                <input type="checkbox" name="checkDrinks[]" value="Royal" 
                    <?php if (isset($_POST['checkDrinks']) && in_array('Royal', $_POST['checkDrinks'])) echo 'checked'; ?>> Royal - ₱20<br>
                <input type="checkbox" name="checkDrinks[]" value="Pepsi" 
                    <?php if (isset($_POST['checkDrinks']) && in_array('Pepsi', $_POST['checkDrinks'])) echo 'checked'; ?>> Pepsi - ₱15<br>
                <input type="checkbox" name="checkDrinks[]" value="Mountain Dew" 
                    <?php if (isset($_POST['checkDrinks']) && in_array('Mountain Dew', $_POST['checkDrinks'])) echo 'checked'; ?>> Mountain Dew - ₱20<br>
            </label>
        </fieldset>
        ...
        <fieldset style="height: 35px;width: 420px;">
            ...
            <select name="size">
                <option value="regular" 
                    <?php if (isset($_POST['size']) && $_POST['size'] == 'regular') echo 'selected'; ?>>Regular</option>
                <option value="up" 
                    <?php if (isset($_POST['size']) && $_POST['size'] == 'up') echo 'selected'; ?>>Up-Size (add ₱5)</option>
                <option value="jumbo" 
                    <?php if (isset($_POST['size']) && $_POST['size'] == 'jumbo') echo 'selected'; ?>>Jumbo (add ₱10)</option>
            </select>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!empty($selectedProducts)) {
                ...
                foreach ($selectedProducts as $product) {
                    ...
                    echo '<span style="font-weight: bold;">·</span> ' . $quantity . ' ' . $itemText . ' of Regular ' . $product . 
                         ' amounting to ₱ ' . $itemPrice . '<br>';
